...
QtObject {
    ...
    readonly property color surface:         "#160e12"
    readonly property color surfaceHigh:     "#1f171b"
    readonly property color surfaceTop:      "#282024"
    
    readonly property color accent:          "#e85f6f"
    readonly property color accentSoft:      "#ebb97e"
    readonly property color border:          "#2f272b"
    ...
    readonly property color surfaceBright: "#1f171b"
    readonly property color surfaceContainerLowest: "#0d0509"
    readonly property color surfaceContainerLow: "#0d0509"
    readonly property color surfaceContainer: "#160e12"
    readonly property color surfaceContainerHigh: "#1f171b"
    readonly property color surfaceContainerHighest: "#282024"
    readonly property color surfaceFg: "#f0eaed"
    readonly property color surfaceVariantFg: "#f0eaed"
    readonly property color outline: "#2f272b"
    readonly property color outlineVariant: "#1e161a"
