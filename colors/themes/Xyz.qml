...
QtObject {
    ...
    readonly property color surface:         "#f3e4cb"
    readonly property color surfaceHigh:     "#9f8253"
    readonly property color surfaceTop:      "#f3e4cb"
    ...
    readonly property color surfaceBright: "#9f8253"
    readonly property color surfaceContainerLowest: "#f3e4cb"
    readonly property color surfaceContainerLow: "#f3e4cb"
    readonly property color surfaceContainer: "#f3e4cb"
    readonly property color surfaceContainerHigh: "#9f8253"
    readonly property color surfaceContainerHighest: "#9f8253"
    readonly property color surfaceFg: "#4d2e1a"
    readonly property color surfaceVariantFg: "#080503"
    readonly property color outline: "#9f8253"
    readonly property color outlineVariant: "#9f8253"
